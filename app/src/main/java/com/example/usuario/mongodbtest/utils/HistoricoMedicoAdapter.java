...
public class HistoricoMedicoAdapter extends ArrayAdapter<Atendimento> {
    private List<Atendimento> items;

    public HistoricoMedicoAdapter(Context context, int textViewResourceId, List<Atendimento> items) {
