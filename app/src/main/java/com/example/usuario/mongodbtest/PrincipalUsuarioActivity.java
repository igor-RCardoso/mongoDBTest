...
public class PrincipalUsuarioActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final AgendaPacienteAdapter adapter =
                new AgendaPacienteAdapter(getBaseContext(), R.layout.atendimento_lista_modelo, atendimentos);
...
//                Atendimento atendimento = adapter.getItem(position);
//                Log.e("olar",atendimento.get());
//                it = new Intent(getBaseContext(), EventoActivity.class);
//                it.putExtra("evento", atendimento);
//                startActivity(it);
//            }
//        });
    }

    public void marcarConsulta(View v) {
        Intent it = new Intent(this, BuscarMedicoActivity.class);
        startActivity(it);
    }
