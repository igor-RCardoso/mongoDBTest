...
public class AgendaMedicoAdapter extends ArrayAdapter<Atendimento> {
    private List<Atendimento> items;

    public AgendaMedicoAdapter(Context context, int textViewResourceId, List<Atendimento> items) {
